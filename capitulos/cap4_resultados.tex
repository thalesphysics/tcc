...
onde a reta é $\Delta G_{DFT} = 0.767 \Delta G_{DFTB} + 0.469$ eV. Além disso, o RMSE para o ajuste é de $0.243$, fazendo com que os valores calculados utilizando o DFTB muito próximos a zero estejam dentro do intervalo ideal de $\Delta G$.
